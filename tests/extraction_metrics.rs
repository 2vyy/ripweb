...
fn metric_baseline_docs_sidebar() {
    assert_fixture_metrics("tests/extraction/generic/docs_sidebar.html");
}

#[test]
fn metric_baseline_listing_results() {
    assert_fixture_metrics("tests/extraction/generic/listing_results.html");
}

#[test]
fn metric_baseline_product_detail() {
    assert_fixture_metrics("tests/extraction/generic/product_detail.html");
}

#[test]
fn metric_baseline_forum_thread() {
    assert_fixture_metrics("tests/extraction/generic/forum_thread.html");
}

#[test]
fn metric_baseline_bloated_generic() {
    assert_fixture_metrics("tests/extraction/generic/bloated_generic.html");
}
